<?php
  ...
  $fullName = $user->getFullNome($userData);
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="sobrenome" name="sobrenome" placeholder="Digite o seu nome" value="<?= $userData->sobrenome ?>">
            </div>
            <div class="form-group">
